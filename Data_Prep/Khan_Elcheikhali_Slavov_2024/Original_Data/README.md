Download the following files into this directory before running `Khan_prep_for_NIFty.py`.

1. Navigate to `https://drive.google.com/drive/folders/1iboBCc1zxTvzfxZM8VoS_EZZrFVDuSlI `
2. Download `npop5_proteinMatrix_Imputed.BCmTRAQ.txt` and `npop5_proteinMatrix_NoImp.BCmTRAQ.txt`
