...
imputed_raw_path = os.path.join(script_directory, "Original_Data", "t6.csv")
...
unimputed_raw_path = os.path.join(script_directory, "Original_Data", "t7.csv")
...
# filter the meta data file to just the cell types (m and u)
meta = meta_raw[(meta_raw['celltype'] == "m") | (meta_raw['celltype'] == "u")]
