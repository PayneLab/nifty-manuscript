...
# input files
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Khan_Elcheikhali_Slavov_2024', 'NIFty_Ready_Data', 'quant_unimputed_wt.tsv')
...
for split in splits:
    for i in range(tests):
        ...
        identifier = f"Saddic_Unimputed_WT_Split{split}_Test{test + 1}"
