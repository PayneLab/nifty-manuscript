...
# input files
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Saddic_Parker_2026', 'NIFty_Ready_Data', 'quant_unimputed_wt.tsv')
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Saddic_Parker_2026', 'NIFty_Ready_Data', 'meta_wt.tsv')
...
main_output_dir = os.path.join(script_directory, 'Test_Saddic_Unimputed_WT')
...
for split in splits:
    for i in range(tests):
        ...
        identifier = f"Saddic_Unimputed_WT_Split{split}_Test{i + 1}"
