...
# input files
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Saddic_Parker_2025', 'NIFty_Ready_Data', 'quant_imputed_smc.tsv')
...
for split in splits:
    for i in range(tests):
        ...
        identifier = f"Saddic_Imputed_SMC_Split{split}_Test{i + 1}"
