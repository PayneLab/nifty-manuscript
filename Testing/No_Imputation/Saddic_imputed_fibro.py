...
# input files
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Khan_Elcheikhali_Slavov_2024', 'NIFty_Ready_Data', 'quant_imputed_fibro.tsv')
...
main_output_dir = os.path.join(script_directory, 'Test_Saddic_Imputed_Fibro')
...
for split in splits:
    for i in range(tests):
        ...
        identifier = f"Saddic_Imputed_Fibro_Split{split}_Test{test + 1}"
