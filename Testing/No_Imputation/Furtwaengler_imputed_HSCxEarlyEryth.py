...
# input files
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Furtwaengler_Porse_Schoof_2025', 'NIFty_Ready_Data', 'quant_imputed.tsv')
...
main_output_dir = os.path.join(script_directory, 'Test_Furtwaengler_Imputed_HSCxEarlyEryth')
...
for split in splits:
    for i in range(tests):
        ...
        identifier = f"Furtwaengler_Imputed_HSCxEE_Split{split}_Test{test + 1}"
