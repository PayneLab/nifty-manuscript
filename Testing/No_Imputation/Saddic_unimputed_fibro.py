...
# input files
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Saddic_Parker_2025', 'NIFty_Ready_Data', 'quant_unimputed_fibro.tsv')
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Saddic_Parker_2025', 'NIFty_Ready_Data', 'meta_fibro.tsv')
