...
# input files
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Khan_Elcheikhali_Slavov_2024', 'NIFty_Ready_Data', 'quant_imputed.tsv')
...
main_output_dir = os.path.join(script_directory, 'Test_Khan_Imputed')
...
for split in splits:
    for i in range(tests):
        ...
        identifier = f"Khan_Imputed_Split{split}_Test{test + 1}"
