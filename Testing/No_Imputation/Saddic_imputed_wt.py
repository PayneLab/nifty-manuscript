...
# input files
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Saddic_Parker_2026', 'NIFty_Ready_Data', 'quant_imputed_wt.tsv')
...
main_output_dir = os.path.join(script_directory, 'Test_Saddic_Imputed_WT')
...
for split in splits:
    for i in range(tests):
        ...
        identifier = f"Saddic_Imputed_WT_Split{split}_Test{i + 1}"
