...
# input files
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Saddic_Parker_2026', 'NIFty_Ready_Data', 'quant_unimputed_smc.tsv')
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Saddic_Parker_2026', 'NIFty_Ready_Data', 'meta_smc.tsv')
