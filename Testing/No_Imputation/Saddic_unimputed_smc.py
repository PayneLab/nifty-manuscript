...
# input files
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Saddic_Parker_2025', 'NIFty_Ready_Data', 'quant_unimputed_smc.tsv')
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Saddic_Parker_2025', 'NIFty_Ready_Data', 'meta_smc.tsv')
...
main_output_dir = os.path.join(script_directory, 'Test_Saddic_Unimputed_SMC')
...
for split in splits:
    for i in range(tests):
        ...
        identifier = f"Saddic_Unimputed_SMC_Split{split}_Test{test + 1}"
