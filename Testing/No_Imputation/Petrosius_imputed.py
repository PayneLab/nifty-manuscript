...
# input files
quant_file = os.path.join(script_directory, os.pardir, os.pardir, 'Data_Prep', 'Petrosius_Schoof_2025', 'NIFty_Ready_Data', 'quant_imputed.tsv')
...
main_output_dir = os.path.join(script_directory, 'Test_Petrosius_Imputed')
